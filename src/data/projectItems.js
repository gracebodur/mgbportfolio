...
const projectItems = [
  ...
  },
  {
    ...
    title: "Jot",
    description:
      "A note taking app based on Google's Keep note-taking service where users can add, edit and delete a note. Notes are stored and access using LocalStorage so created notes will persist even after the browser window is closed. Built using HTML, CSS and JavaScript.",
