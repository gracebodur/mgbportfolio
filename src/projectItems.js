...
const projectItems = [
    {
        ...
        imgUrl: gottalotto,
        title: 'GottaLotto',
        description: "GottaLotto is a team project built to show our knowledge of Data Structure and Algorithms by creating a guessing game app. GottaLotto is for lotto enthusiasts to have plain old fun in guessing the winning numbers for each Saturday's PowerBall 's drawing. It allows users to submit their guesses for the upcoming drawing and a text area where users can include their lottery experience message. Submitted guesses are compared and scored based on how close they get from the Powerball winning numbers.",
