        ...
        <div className='about-wrapper' id='about'>
            <section className="about-section">
                ...
                <div className="container-s">
                    ...
                    <p className='about-text text-left'>I'm excited to <a href="https://www.linkedin.com/in/mgracebodur/" className='lead connect' target='_blank' rel='noreferrer' alt='connect with linkedin'>connect</a> with companies and colleagues that inspire me!</p>
                </div>
            </section>
        </div>
    )
